...
## Key features
The JavaScript PDF Viewer component allows to view, print, and annotate the PDF files in your JavaScript applications and its key features are,
...
* [Annotations](https://help.syncfusion.com/document-processing/pdf/pdf-viewer/javascript-es5/annotations/overview/) - Annotate with text markup, shapes, stamps, ink, and sticky notes.
* [Form Fields](https://help.syncfusion.com/document-processing/pdf/pdf-viewer/javascript-es5/forms/overview/) - Form filling and form designing can be done.
* [Signature](https://help.syncfusion.com/document-processing/pdf/pdf-viewer/javascript-es5/annotations/signature-annotation/) - Hand-written and digital signatures are allowed.
...
* [Search](https://help.syncfusion.com/document-processing/pdf/pdf-viewer/javascript-es5/text-search/text-search-features/) - Search a text easily across the PDF document.	
...
* [Print](https://help.syncfusion.com/document-processing/pdf/pdf-viewer/javascript-es5/print/overview/) - Print the entire document or a specific page directly from the browser.
* [Download](https://help.syncfusion.com/document-processing/pdf/pdf-viewer/javascript-es5/download/) - Download the complete document currently loaded in the PDF Viewer.
* [Text Selection](https://help.syncfusion.com/document-processing/pdf/pdf-viewer/javascript-es5/textselection/) - Select and copy text from a PDF file.
...
* <a href="Form Designer">Form Designer</a>
* <a href="Form Fields">Form Fields</a>
* <a href="How to">How to</a>
* <a href="Localization">Localization</a>
* <a href="Save and Load">Save and Load</a>
